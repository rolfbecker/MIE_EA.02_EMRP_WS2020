...
def update_graph_live(n):
    ...
    fig = px.scatter_mapbox(df_final, lat="latitude", lon="longitude", hover_name="sensor_id", hover_data=["sensor_id", "temp", "ec", "sm", "bat"],
                            color= 'sensor_id', color_continuous_scale=px.colors.sequential.YlOrRd, zoom=15, height=800, size='latitude', size_max=20)
